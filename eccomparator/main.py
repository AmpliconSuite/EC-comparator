...
from eccomparator.configs import Configs
...
def config(args):
	...
	if dict[h.BREAKPOINT_DISTANCE][h.BREAKPOINT_DISTANCE_CALCULATION] in [
		...
		d.BP_GAUSSIAN_CONFIDENCE_UNWEIGHTED,
		d.BP_GAUSSIAN_CONFIDENCE_CN_WEIGHTED,
	]:
	...
	dict[h.BREAKPOINT_DISTANCE][d.UNMATCHED_DISTANCE] = args.breakpoint_selection_distance
	...
	if args.breakpoint_selection_distance == d.GAUSSIAN:
		...
		dict[h.BREAKPOINT_DISTANCE][d.UNMATCHED_THRESHOLD] = args.breakpoint_selection_threshold
	...
	if args.breakpoint_cost_function == d.EUCLIDIAN:
		...
		dict[h.BREAKPOINT_DISTANCE][d.EUCLIDIAN][h.THRESHOLD] = args.breakpoint_cost_function_threshold
		...
		dict[h.BREAKPOINT_DISTANCE][d.RELATIVE_METRIC][h.THRESHOLD] = args.breakpoint_cost_function_threshold
